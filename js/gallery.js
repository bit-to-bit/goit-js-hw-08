...
const allGalleryCards = images.map(el => createGalleryCard(el)).join('');

const rootGalleryEl = document.querySelector('.gallery');

rootGalleryEl.innerHTML = allGalleryCards;

rootGalleryEl.addEventListener('click', event => {
